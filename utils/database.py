...
db_username = urllib.parse.quote_plus(str(os.environ.get('mota_db_username', 'paymoja')))
db_password = urllib.parse.quote_plus(str(os.environ.get('mota_db_password', 'paymoja')))
